...
function SvgIcon({ children, className = 'w-4 h-4', ...props }) {
  return (
    <svg
      className={className}
      fill="none"
...
export function IconFileExport(props) {
  return (
    <SvgIcon {...props}>
      <path
        strokeLinecap="round"
...
export function IconFilterOff(props) {
  return (
    <SvgIcon {...props}>
      <path
        strokeLinecap="round"
...
export function IconHourglass({ spinning, className = 'w-10 h-10', ...props }) {
  return (
    <SvgIcon
    ...
    >
      <path
        ...
        strokeLinejoin="round"
        strokeWidth="1.5"
        d="M6 2h12M6 22h12M8 2v4.5a4 4 0 004 4 4 4 0 004-4V2M8 22v-4.5a4 4 0 014-4 4 4 0 014 4V22M12 10.5V13"
      />
    </SvgIcon>
  );
}

export function IconToggleOff(props) {
  return (
    <SvgIcon {...props}>
      <path
        strokeLinecap="round"
